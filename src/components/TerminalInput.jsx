    ...
    switch (trimmed) {
      ...
      case "features":
        output = `<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
                    <section class="flex flex-col justify-between bg-transparent border border-dashed border-gray-700 shadow-[0_0_10px_rgba(255,255,255,0.08)] rounded-lg p-4 transition-all hover:scale-[1.02] active:scale-95 duration-200">
                      <div>
                      ...
                      <button class="mt-2 bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md shadow-[0_0_6px_rgba(255,255,255,0.1)] transition-all">Learn More</button>
                    </section>
      ...
      case "help":
        ...
        break;
      case "socials":
        output = `Find me on <a class="text-blue-400 underline" href="https://github.com/Mansiverma30" target="_blank">GitHub</a>, LinkedIn & more.`;
        break;
      case "clear":
        setHistory([]);
        setInput("");
