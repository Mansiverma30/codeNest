...
import JsTerminalInput from "./JsTerminalInput";
...
function Js() {
  const terminalLines = [
   ...
   <span class='text-zinc-300 ml-4'>    Go back to the topics page</span>`,
    `<span class='text-green-400'>    intro, 'variables, arrays, and objects', 'functions, conditions, and loops', 'events and dom', & best practices</span>`,
